angular.module('app')
    .controller('ResetPasswordController', function ($scope, Member, $state, $rootScope, LoopBackAuth, $stateParams, $http, cfpLoadingBar) {
        ...
        $scope.save = function () {
            ...
            Member.resetPassword({ email: $stateParams.email, password: $scope.user.password, password_confirmation: $scope.user.confirm_password, id: $stateParams.id }, function (response, headers) {
